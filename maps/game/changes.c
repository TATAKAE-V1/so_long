...
/*   Updated: 2023/01/27 00:38:48 by ofarhat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	change_u(t_game *game, int y, int x)
{
	game->img = mlx_xpm_file_to_image(game->mlx_ptr,
			"./textures/pu.xpm", &game->width, &game->height);
	if (!game->img)
	{
...
{
	game->img = mlx_xpm_file_to_image(game->mlx_ptr,
			"./textures/pr.xpm", &game->width, &game->height);
	if (!game->img)
	{
		ft_putstr("Error with your xpms");
		exit(1);
...
{
	game->img = mlx_xpm_file_to_image(game->mlx_ptr,
			"./textures/pl.xpm", &game->width, &game->height);
	if (!game->img)
	{
		ft_putstr("Error with your xpms");
		exit(1);
...
{
	game->img = mlx_xpm_file_to_image(game->mlx_ptr,
			"./textures/e.xpm", &game->width, &game->height);
	if (!game->img)
	{
		ft_putstr("Error with your xpms");
		exit(1);
